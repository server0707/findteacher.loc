                        ...
                        <div class="col-lg-3 col-md-4 item mt-md-0 mt-5">
                            <div class="card">
                                ...
                                <div class="card-body course-details" style="height: 200px; overflow: auto">
                                    ...
                                    <a href="<?= \yii\helpers\Url::to(['site/teacher-details', 'id' => $teacher->id]) ?>"
                                       class="course-desc"><?= $teacher['description_' . $lang] ?></a>
                                </div>
                                <div class="card-footer">
                                    <div class="author align-items-center">
                                        <img src="<?= $teacher->getImage()->getUrl() ?>" alt="Image of Teacher"
                                             class="img-fluid rounded-circle">
                                        <ul class="blog-meta">
                                            <li>
                                                <span class="meta-value mx-1"><?= ($teacher->getAge() !== '') ? Yii::t('yii', 'Age') . ':' : '' ?> </span> <?= $teacher->getAge() ?>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
